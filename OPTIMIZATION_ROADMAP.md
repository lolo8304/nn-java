...
**Start next with OPT-06.** OPT-05 is complete; see [inference results](benchmarks/NO_GRAD_RESULTS.md).
...
latency speedup claim. Larger-shape measurements remain necessary for OPT-06.
