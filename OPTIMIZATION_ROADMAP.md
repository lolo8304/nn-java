...
**Start next with OPT-07.** OPT-06 is complete; see [transposed matmul results](benchmarks/TRANSPOSED_MATMUL_RESULTS.md).
...
OPT-07 onward is provisional until larger-shape and real-data profiles support the order.
